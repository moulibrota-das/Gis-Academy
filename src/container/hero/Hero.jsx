  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Unlock the power of <span className="font-semibold text-forestGreen">GIS & Remote Sensing</span>  
          to drive innovation and decision-making. Analyze spatial data,  
          build interactive maps, and shape the future with cutting-edge geospatial technology.
        </motion.p>
